...
class Workflow
{
    ...
    const WorkflowRoles = [
        ...
        'AGENCE_REGIONALE' => [
            'code' => "AGENCE_REGIONALE",
            'name' => "Agence régionale (générique)",
        ...
        'CHEF_SERVICE_FIN_MONITORING' => [
            'code' => "CHEF_SERVICE_FIN_MONITORING",
        ...
        'SOUS_DIR_PARTENARIAT_FINANCEMENT' => [
            'code' => "SOUS_DIR_PARTENARIAT_FINANCEMENT",
        ...
        'DIRECTEUR_PARTENARIAT_FINANCEMENT' => [
            'code' => "DIRECTEUR_PARTENARIAT_FINANCEMENT",
            'name' => "Directeur du partenariat et financement (DPF)",
        ...
        'SOCIETE_RECOUVREMENT' => [
            'code' => "SOCIETE_RECOUVREMENT",
            'name' => "Société de recouvrement (CO2CI)",
    ...
    const WorkflowEtapesRoles = [
        'AGR_CLASSIQUE' => [
            ['etape_code' => "AGRC_PRCO_2", 'role_code' => "CHEF_AGENCE", 'action' => "AJOUT_PLAN_AFFAIRES"],
            ['etape_code' => "AGRC_PRCO_3", 'role_code' => "CHEF_SERVICE_DRF", 'action' => "TRANSMISSION"],
            ['etape_code' => "AGRC_PRCO_3", 'role_code' => "AGENT_DRF", 'action' => "TRANSMISSION"],
            ['etape_code' => "AGRC_PRCO_4", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "TRAITEMENT"],
            ['etape_code' => "AGRC_PRCO_5_1", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "SAISIE_DECAISSEMENT"],
            ['etape_code' => "AGRC_PRCO_5_2", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "SAISIE_REMBOURSEMENT"],
            ...
            ['etape_code' => "AGRC_PRCO_6", 'role_code' => "AGENCE_REGIONALE", 'action' => "VISITE_SUIVI"],
            ['etape_code' => "AGRC_PRCO_6", 'role_code' => "DIRECTEUR_PARTENARIAT_FINANCEMENT", 'action' => "VISITE_SUIVI"],
        ],
        'MPE' => [
            ['etape_code' => "MPE_PRCO_2", 'role_code' => "CHEF_SERVICE_DRF", 'action' => "AJOUT_PLAN_AFFAIRES_TRANSMISSION"],
            ['etape_code' => "MPE_PRCO_2", 'role_code' => "AGENT_DRF", 'action' => "TRANSMISSION"],
            ['etape_code' => "MPE_PRCO_3", 'role_code' => "CHEF_SERVICE_FIN_MONITORING", 'action' => "IMPUTATION"],
            ['etape_code' => "MPE_PRCO_4", 'role_code' => "CIP", 'action' => "SAISIE_PLAN_DECAISSEMENT"],
            ['etape_code' => "MPE_PRCO_4", 'role_code' => "AGENT_DIRECTION", 'action' => "SAISIE_PLAN_DECAISSEMENT"],
            ['etape_code' => "MPE_PRCO_4", 'role_code' => "BENEFICIAIRE", 'action' => "VALIDATION_MOBILE"],
            ['etape_code' => "MPE_PRCO_5_1", 'role_code' => "CIP", 'action' => "ENVOI"],
            ['etape_code' => "MPE_PRCO_5_1", 'role_code' => "CHEF_AGENCE", 'action' => "VALIDATION"],
            ['etape_code' => "MPE_PRCO_5_2", 'role_code' => "AGENT_DIRECTION", 'action' => "ENVOI"],
            ['etape_code' => "MPE_PRCO_5_2", 'role_code' => "CHEF_SERVICE_FIN_MONITORING", 'action' => "RECEPTION"],
            ['etape_code' => "MPE_PRCO_5", 'role_code' => "CHEF_SERVICE_DRF", 'action' => "VERIFICATION"],
            ['etape_code' => "MPE_PRCO_5", 'role_code' => "SOUS_DIR_EVAL_FINANCIERE", 'action' => "VALIDATION"],
            ['etape_code' => "MPE_PRCO_5", 'role_code' => "SOUS_DIR_PARTENARIAT_FINANCEMENT", 'action' => "VALIDATION"],
            ['etape_code' => "MPE_PRCO_5", 'role_code' => "DIRECTEUR_PARTENARIAT_FINANCEMENT", 'action' => "VALIDATION_FINALE"],
            ['etape_code' => "MPE_PRCO_6", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "TRAITEMENT"],
            ['etape_code' => "MPE_PRCO_7_1", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "AUTORISATION"],
            ['etape_code' => "MPE_PRCO_7_1", 'role_code' => "AGENCE_REGIONALE", 'action' => "EXECUTION"],
            ['etape_code' => "MPE_PRCO_7_2", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "SAISIE_REMBOURSEMENT"],
            ['etape_code' => "MPE_PRCO_7_2", 'role_code' => "SOCIETE_RECOUVREMENT", 'action' => "RECOUVREMENT"],
            ...
            ['etape_code' => "MPE_PRCO_7_2", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "RAPPEL_GARANTIE"],
            ['etape_code' => "MPE_PRCO_8", 'role_code' => "AGENCE_REGIONALE", 'action' => "VISITE_SUIVI"],
            ['etape_code' => "MPE_PRCO_8", 'role_code' => "DIRECTEUR_PARTENARIAT_FINANCEMENT", 'action' => "VISITE_SUIVI"],
            ['etape_code' => "MPE_PRCO_6", 'role_code' => "ANALYSTE_FINANCIER", 'action' => "CONSULTATION"],
        ],
        'MEPS' => [
            ['etape_code' => "MEPS_PRCO_2", 'role_code' => "CHEF_SERVICE_DRF", 'action' => "AJOUT_PLAN_AFFAIRES_TRANSMISSION"],
            ['etape_code' => "MEPS_PRCO_2", 'role_code' => "AGENT_DRF", 'action' => "TRANSMISSION"],
            ['etape_code' => "MEPS_PRCO_3", 'role_code' => "CHEF_SERVICE_FIN_MONITORING", 'action' => "IMPUTATION"],
            ['etape_code' => "MEPS_PRCO_4", 'role_code' => "CIP", 'action' => "SAISIE_PLAN_DECAISSEMENT"],
            ['etape_code' => "MEPS_PRCO_4", 'role_code' => "AGENT_DIRECTION", 'action' => "SAISIE_PLAN_DECAISSEMENT"],
            ['etape_code' => "MEPS_PRCO_4", 'role_code' => "BENEFICIAIRE", 'action' => "VALIDATION_MOBILE"],
            ['etape_code' => "MEPS_PRCO_5_1", 'role_code' => "CIP", 'action' => "ENVOI"],
            ['etape_code' => "MEPS_PRCO_5_1", 'role_code' => "CHEF_AGENCE", 'action' => "VALIDATION"],
            ['etape_code' => "MEPS_PRCO_5_2", 'role_code' => "AGENT_DIRECTION", 'action' => "ENVOI"],
            ['etape_code' => "MEPS_PRCO_5_2", 'role_code' => "CHEF_SERVICE_FIN_MONITORING", 'action' => "RECEPTION"],
            ['etape_code' => "MEPS_PRCO_5", 'role_code' => "CHEF_SERVICE_DRF", 'action' => "VERIFICATION"],
            ['etape_code' => "MEPS_PRCO_5", 'role_code' => "SOUS_DIR_EVAL_FINANCIERE", 'action' => "VALIDATION"],
            ['etape_code' => "MEPS_PRCO_5", 'role_code' => "SOUS_DIR_PARTENARIAT_FINANCEMENT", 'action' => "VALIDATION"],
            ['etape_code' => "MEPS_PRCO_5", 'role_code' => "DIRECTEUR_PARTENARIAT_FINANCEMENT", 'action' => "VALIDATION_FINALE"],
            ['etape_code' => "MEPS_PRCO_6", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "TRAITEMENT"],
            ['etape_code' => "MEPS_PRCO_7_1", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "AUTORISATION"],
            ['etape_code' => "MEPS_PRCO_7_1", 'role_code' => "AGENCE_REGIONALE", 'action' => "EXECUTION"],
            ['etape_code' => "MEPS_PRCO_7_2", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "SAISIE_REMBOURSEMENT"],
            ['etape_code' => "MEPS_PRCO_7_2", 'role_code' => "SOCIETE_RECOUVREMENT", 'action' => "RECOUVREMENT"],
            ...
            ['etape_code' => "MEPS_PRCO_7_2", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "RAPPEL_GARANTIE"],
            ['etape_code' => "MEPS_PRCO_8", 'role_code' => "AGENCE_REGIONALE", 'action' => "VISITE_SUIVI"],
            ['etape_code' => "MEPS_PRCO_8", 'role_code' => "DIRECTEUR_PARTENARIAT_FINANCEMENT", 'action' => "VISITE_SUIVI"],
            ['etape_code' => "MEPS_PRCO_6", 'role_code' => "ANALYSTE_FINANCIER", 'action' => "CONSULTATION"],
        ],
        'STARTUP_BOOST' => [
            ['etape_code' => "START_PRCO_2", 'role_code' => "CHEF_SERVICE_DRF", 'action' => "AJOUT_PLAN_AFFAIRES_TRANSMISSION"],
            ['etape_code' => "START_PRCO_3_1", 'role_code' => "CIP", 'action' => "SAISIE_PLAN_DECAISSEMENT"],
            ['etape_code' => "START_PRCO_3_1", 'role_code' => "BENEFICIAIRE", 'action' => "VALIDATION_MOBILE"],
            ['etape_code' => "START_PRCO_3_2", 'role_code' => "SERVICE_GARANTIE_CONTENTIEUX", 'action' => "AJOUT_CONVENTION"],
            ['etape_code' => "START_PRCO_4", 'role_code' => "CIP", 'action' => "ENVOI"],
            ['etape_code' => "START_PRCO_4", 'role_code' => "CHEF_AGENCE", 'action' => "VALIDATION"],
            ['etape_code' => "START_PRCO_4", 'role_code' => "CHEF_SERVICE_DRF", 'action' => "VERIFICATION"],
            ['etape_code' => "START_PRCO_4", 'role_code' => "SOUS_DIR_EVAL_FINANCIERE", 'action' => "VALIDATION"],
            ['etape_code' => "START_PRCO_4", 'role_code' => "SOUS_DIR_PARTENARIAT_FINANCEMENT", 'action' => "VALIDATION"],
            ['etape_code' => "START_PRCO_4", 'role_code' => "DIRECTEUR_PARTENARIAT_FINANCEMENT", 'action' => "VALIDATION_FINALE"],
            ['etape_code' => "START_PRCO_5", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "TRAITEMENT"],
            ['etape_code' => "START_PRCO_5", 'role_code' => "ANALYSTE_FINANCIER", 'action' => "CONSULTATION"],
            ['etape_code' => "START_PRCO_6_1", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "AUTORISATION"],
            ['etape_code' => "START_PRCO_6_1", 'role_code' => "AGENCE_REGIONALE", 'action' => "EXECUTION"],
            ['etape_code' => "START_PRCO_6_2", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "SAISIE_REMBOURSEMENT"],
            ['etape_code' => "START_PRCO_6_2", 'role_code' => "SOCIETE_RECOUVREMENT", 'action' => "RECOUVREMENT"],
            ...
            ['etape_code' => "START_PRCO_6_2", 'role_code' => "PARTENAIRE_FINANCIER", 'action' => "RAPPEL_GARANTIE"],
            ['etape_code' => "START_PRCO_7", 'role_code' => "AGENCE_REGIONALE", 'action' => "VISITE_SUIVI"],
            ['etape_code' => "START_PRCO_7", 'role_code' => "DIRECTEUR_PARTENARIAT_FINANCEMENT", 'action' => "VISITE_SUIVI"],
        ],
    ...
    const WorkflowEtapesDecision = [
        ...
        'MEPS' => [
            ...
            [
                ...
                'name' => "Validation par le sous-directeur de l'évaluation financière",
                'role_code' => "SOUS_DIR_EVAL_FINANCIERE",
                'outcomes' => ["VALIDE", "REJETE"],
            ],
            [
                'etape_code' => "MEPS_PRCO_5",
                ...
                'name' => "Validation par le sous-directeur du partenariat et financement",
                'role_code' => "SOUS_DIR_PARTENARIAT_FINANCEMENT",
                'outcomes' => ["VALIDE", "REJETE"],
            ],
            [
                'etape_code' => "MEPS_PRCO_5",
                ...
                'name' => "Validation finale par le Directeur du partenariat et financement",
                'role_code' => "DIRECTEUR_PARTENARIAT_FINANCEMENT",
                'outcomes' => ["VALIDE", "REJETE"],
            ],
            [
                ...
                'name' => "Approbation ou non du dossier par le partenaire financier",
                'role_code' => "PARTENAIRE_FINANCIER",
                'outcomes' => ["APPROUVE", "REJETE"],
            ],
            [
