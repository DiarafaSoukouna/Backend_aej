    ...
    public function store(Request $request) : JsonResponse
    {
        ...
        try{
            ...
            if ($request->hasFile('logo_systeme')) {
                $data['logo_systeme'] = $request->file('logo_systeme')->store('configurations/logo_systeme','public');
            }
            if ($request->hasFile('logo_structure')) {
                $data['logo_structure'] = $request->file('logo_structure')->store('configurations/logo_structure','public');
            }
