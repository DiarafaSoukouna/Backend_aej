...
use App\Http\Controllers\LotMicroProjetController;
use App\Http\Controllers\LotImportationController;
use App\Http\Controllers\GarantieController;
use App\Http\Controllers\LigneDecaissementController;
use App\Http\Controllers\ExecutionLigneDecaissementController;
use App\Http\Controllers\PlanRemboursementController;
use App\Http\Controllers\TableauAmortissementController;
...
// Route::middleware('checkMaintenance')->group(function () {
    ...
    // Route::middleware('verifyToken')->group(function () {
        ...
        Route::post('budgets/multiple', [BudgetController::class, 'storeMultiple']);
        Route::apiResource('compte-financements', CompteFinancementController::class);
        Route::patch('compte-financements/{id}', [CompteFinancementController::class, 'patch']);
        Route::apiResource('plan-decaissements', PlanDecaissementController::class);
        Route::patch('plan-decaissements/{id}', [PlanDecaissementController::class, 'patch']);
        Route::apiResource('plan-remboursements', PlanRemboursementController::class);
        Route::patch('plan-remboursements/{id}', [PlanRemboursementController::class, 'patch']);
        ...
        Route::apiResource('execution-ligne-decaissements', ExecutionLigneDecaissementController::class);
        Route::patch('execution-ligne-decaissements/{id}', [ExecutionLigneDecaissementController::class, 'patch']);
        ...
        Route::prefix('documents')->group(function () {
            ...
            Route::get('/path/{path}', [DocumentController::class, 'pathDocuments'])->where('path', '.*');
